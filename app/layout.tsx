...
export const metadata: Metadata = {
  ...
  description: 'Explore Pooja R. Sonar\'s software development portfolio featuring scalable web applications, AI-powered platforms, and real-time systems expertise.',
  keywords: 'software developer, web development, AI platforms, MERN stack, real-time systems, Pooja Sonar',
  openGraph: {
    type: 'website',
    title: 'Pooja R. Sonar - Software Developer Portfolio',
    description: 'Explore Pooja R. Sonar\'s software development portfolio featuring scalable web applications, AI-powered platforms, and real-time systems expertise.',
